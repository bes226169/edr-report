...
namespace EDR_Report
{
    ...
    public class Captcha
    {
        ...
        public static CaptchaResult GenerateCaptchaImage(int width, int height, string captchaCode)
        {
            ...
            int GetFontSize(int imageWidth, int captchCodeCount) => Convert.ToInt32(imageWidth / captchCodeCount);

            Color GetRandomDeepColor() => Color.FromArgb(rand.Next(160), rand.Next(100), rand.Next(160));
            ...
            void DrawCaptchaCode()
            {
                ...
                for (var i = 0; i < captchaCode.Length; i++)
                {
                    ...
                    float x = i * fontSize + 5;//i * fontSize + rand.Next(-shiftPx, shiftPx) + rand.Next(-shiftPx, shiftPx);
